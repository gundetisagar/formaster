...
def test_create_observation_with_all_valid_details_create_observation():
    # Arrange
    user_id = 1
    title = "12345"
    category_id = 1
    ...
    # Assert
    presenter.raise_exception_for_invalid_title.assert_not_called()
    presenter.raise_exception_for_invalid_title_length.assert_not_called()
    presenter.raise_exception_for_invalid_category_id.assert_not_called()
    presenter.raise_exception_for_invalid_sub_category_id.assert_not_called()
    presenter.raise_exception_for_invalid_description_content.assert_not_called()
    presenter.raise_exception_for_invalid_description_length.assert_not_called()
    observation_storage.create_obsevation.assert_called_once_with(
        user_id=user_id,
        title=title,
        category_id=category_id,
        sub_category_id=sub_category_id,
