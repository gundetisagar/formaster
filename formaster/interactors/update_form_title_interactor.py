...
class UpdateFormTitleInteractor:
    ...
    def update_form_title(self, user_id:int, form_id: int,
                          new_form_title: str):
        try:
        ...
        try:
            ...
            self.presenter.raise_exception_for_user_cannot_update_form()
            return

        form_title_with_id_dto = self.form_storage.update_form_title(
            form_id=form_id, new_form_title=new_form_title
        )
        form_title_with_id_dict = self.presenter.update_form_title_response(
            form_title_with_id_dto=form_title_with_id_dto
        )
